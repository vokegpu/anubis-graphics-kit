...
void agk_batch3d::init() {
    gpu::create_program(agk_batch3d::fx_shape3d, "data/fx/fx_shape3d.vsh", "data/fx/fx_shape3d.fsh", "data/fx/fx_shape3d.gsh");
}
...
void agk_batch3d::draw(const glm::vec3 &pos, const glm::vec4 &color) {
    ...
    agk_batch3d::fx_shape3d.set4f("u_vec_light_pos", &light_pos[0]);
