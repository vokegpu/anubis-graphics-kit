...
void light::on_low_update() {
    ::asset::shader *p_program_material_pbr {(::asset::shader*) agk::asset::find("gpu/effects.material.brdf.pbr")};
    ...
    p_program_material_pbr->set_uniform_vec3(light_index_tag + ".uVector", &this->transform.position[0]);
    glUseProgram(0);

    p_program_material_pbr = (::asset::shader*) agk::asset::find("gpu/effects.terrain.pbr");
